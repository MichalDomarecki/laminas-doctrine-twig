...
This is a skeleton application (with doctrine and twig as template engine added) 
using the Laminas MVC layer and module
systems. This application is meant to be used as a starting place for those
looking to get their feet wet with Laminas MVC. 
Doctrine configuration example in config/autoload/global.php
